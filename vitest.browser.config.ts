...
export default mergeConfig(
  ...
  defineConfig({
    ...
    resolve: {
      alias: {
        "~": srcPath,
        "@cortex/contracts": path.join(rootDir, "contracts/src/index.ts"),
      },
    },
    test: {
      include: [
      ...
      // The full route graph can take more than 30 seconds to compile on a
      // cold Windows cache before an individual browser test can proceed.
      testTimeout: 90_000,
      hookTimeout: 90_000,
    },
  }),
